...
if (isset($options["domain_name"]) && isset($options["item_keypairs"])&& isset($options["replace"])) {
    $domain_name = $options["domain_name"];
    $item_keypairs = $options["item_keypairs"];
    ...
    $response = $sdb->batch_put_attributes ( $domain_name, $item_keypairs, $replace, $opt );
