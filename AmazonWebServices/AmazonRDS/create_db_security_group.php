...
if (isset($options["db_security_group_name"]) && isset($options["db_security_group_description"])) {
    $db_security_group_name = $options["db_security_group_name"];
    $db_security_group_description = $options["db_security_group_description"];
    $opt = array();
    ...
    $response = $rds->create_db_security_group($db_security_group_name, $db_security_group_description, $opt);
