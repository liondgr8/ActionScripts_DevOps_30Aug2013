...
if (isset($options["db_snapshot_identifier"]) && isset($options["db_instance_identifier"])) {
    ...
    $response = $rds->create_db_snapshot($db_snapshot_identifier, $db_instance_identifier, $opt);
