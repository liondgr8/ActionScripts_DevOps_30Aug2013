...
if (isset($options['DBInstanceIdentifier'])) {
    $opt['DBInstanceIdentifier'] = $options['DBInstanceIdentifier'];

}
if (isset($options['DBSnapshotIdentifier'])) {
    $opt['DBSnapshotIdentifier'] = $options['DBSnapshotIdentifier'];
...
$response = $rds->describe_db_snapshots($opt);
