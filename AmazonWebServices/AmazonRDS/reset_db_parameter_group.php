...
if (isset($options["db_parameter_group_name"])) {
    $db_parameter_group_name = $options["db_parameter_group_name"];
    $opt = array();

    if (isset($options['ResetAllParameters'])) {
        $opt['ResetAllParameters'] = $options['ResetAllParameters'];
    ...
    $response = $rds->reset_db_parameter_group($db_parameter_group_name, $opt);
