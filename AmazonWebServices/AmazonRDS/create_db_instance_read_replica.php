...
if (isset($options["db_instance_identifier"]) && isset($options["source_db_instance_identifier"])) {
    ...
    $response = $rds->create_db_instance_read_replica($db_instance_identifier, $source_db_instance_identifier, $opt);
