...
if (isset($options["db_instance_identifier"]) && isset($options["db_snapshot_identifier"])) {
    $db_instance_identifier = $options["db_instance_identifier"];
    $db_snapshot_identifier = $options["db_snapshot_identifier"];
    $opt = array();
    ...
    $response = $rds->restore_db_instance_from_db_snapshot($db_instance_identifier, $db_snapshot_identifier, $opt);
