...
if (isset($options["db_instance_identifier"])) {
    ...
    if (isset($options['SkipFinalSnapshot'])) {
        $opt['SkipFinalSnapshot'] = $options['SkipFinalSnapshot'];

    }
    if (isset($options['FinalDBSnapshotIdentifier'])) {
        $opt['FinalDBSnapshotIdentifier'] = $options['FinalDBSnapshotIdentifier'];
    ...
    $response = $rds->delete_db_instance($db_instance_identifier, $opt);
