...
if (isset($options["load_balancer_name"]) && isset($options["load_balancer_port"]) && isset($options["policy_names"])) {
    ...
    $response = $elb->set_load_balancer_policies_of_listener($load_balancer_name, $load_balancer_port, $policy_names, $opt);
