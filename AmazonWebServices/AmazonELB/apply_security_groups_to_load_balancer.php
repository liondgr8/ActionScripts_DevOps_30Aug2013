...
if (isset($options["load_balancer_name"]) && isset($options["security_groups"])) {
    ...
    $response = $elb->apply_security_groups_to_load_balancer($load_balancer_name, $security_groups, $opt);
