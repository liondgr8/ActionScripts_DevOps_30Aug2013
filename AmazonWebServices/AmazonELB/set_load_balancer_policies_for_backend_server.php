...
if (isset($options["load_balancer_name"]) && isset($options["instance_port"]) && isset($options["policy_names"])) {
    ...
    $response = $elb->set_load_balancer_policies_for_backend_server($load_balancer_name, $instance_port, $policy_names, $opt);
