...
if (isset($options["load_balancer_name"]) && isset($options["load_balancer_ports"])) {
    $load_balancer_name = $options["load_balancer_name"];
    $load_balancer_ports = $options["load_balancer_ports"];
    $opt = array();
    ...
    $response = $elb->delete_load_balancer_listeners($load_balancer_name, $load_balancer_ports, $opt);
