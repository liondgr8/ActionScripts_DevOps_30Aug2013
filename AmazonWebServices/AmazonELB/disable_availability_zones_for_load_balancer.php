...
if (isset($options["load_balancer_name"]) && isset($options["availability_zones"])) {
    ...
    $response = $elb->disable_availability_zones_for_load_balancer($load_balancer_name, $availability_zones, $opt);
