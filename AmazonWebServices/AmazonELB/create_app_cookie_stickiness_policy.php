...
if (isset($options["load_balancer_name"]) && isset($options["policy_name"]) && isset($options["cookie_name"])) {
    ...
    $response = $elb->create_app_cookie_stickiness_policy($load_balancer_name, $policy_name, $cookie_name, $opt);
