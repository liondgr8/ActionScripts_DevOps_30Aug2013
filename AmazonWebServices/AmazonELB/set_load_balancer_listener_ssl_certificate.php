...
if (isset($options["load_balancer_name"]) && isset($options["load_balancer_port"]) && isset($options["ssl_certificate_id"])) {
    $load_balancer_name = $options["load_balancer_name"];
    $load_balancer_port = $options["load_balancer_port"];
    ...
    $response = $elb->set_load_balancer_listener_ssl_certificate($load_balancer_name, $load_balancer_port, $ssl_certificate_id, $opt);
