...
if (isset($options["state_value"]) && isset($options["alarm_name"]) && isset($options["state_reason"])) {
    $state_value = $options["state_value"];
    $alarm_name = $options["alarm_name"];
    $state_reason = $options["state_reason"];
    $opt = array();


    if (isset($options['StateReasonData'])) {
        $opt['StateReasonData'] = $options['StateReasonData'];
    ...
    $response = $cw->set_alarm_state ( $alarm_name, $state_value, $state_reason, $opt );
