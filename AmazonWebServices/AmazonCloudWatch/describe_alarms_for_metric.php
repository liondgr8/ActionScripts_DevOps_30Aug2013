...
if (isset($options["metric_name"]) && isset($options["namespace"])) {
    $metric_name = $options["metric_name"];
    $namespace = $options["namespace"];
    $opt = array();


    if (isset($options['Statistic'])) {
        $opt['Statistic'] = $options['Statistic'];
    ...
    $response = $cw->describe_alarms_for_metric($metric_name, $namespace, $opt);
