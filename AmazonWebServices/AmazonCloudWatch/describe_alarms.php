...
if (isset($options['AlarmNames'])) {
    $opt['AlarmNames'] = $options['AlarmNames'];

}
if (isset($options['AlarmNamePrefix'])) {
    $opt['AlarmNamePrefix'] = $options['AlarmNamePrefix'];

}
if (isset($options['StateValue'])) {
    $opt['StateValue'] = $options['StateValue'];

}
if (isset($options['ActionPrefix'])) {
    $opt['ActionPrefix'] = $options['ActionPrefix'];
...
$response = $cw->describe_alarms( $opt );
