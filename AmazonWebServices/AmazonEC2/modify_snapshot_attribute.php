...
if (isset($options["snapshot_id"])) {
    ...
    if (isset($options['CreateVolumePermission'])) {
        $opt['CreateVolumePermission'] = $options['CreateVolumePermission'];
    ...
    $response = $ec2->modify_snapshot_attribute($snapshot_id, $opt);
