...
if (isset($options["dhcp_options_id"]) && isset($options["vpc_id"])) {
    $dhcp_options_id = $options["dhcp_options_id"];
    ...
    $response = $ec2->associate_dhcp_options($dhcp_options_id, $vpc_id, $opt);
