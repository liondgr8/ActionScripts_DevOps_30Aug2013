...
$longopts = array(
    "instance_id:",
    "DecryptPasswordWithKey::", // Optional value
    "curlopts::",
    "returnCurlHandle::",
);
...
if (isset($options["instance_id"])) {
    ...
    if (isset($options['DecryptPasswordWithKey'])) {
        $opt['DecryptPasswordWithKey'] = $options['DecryptPasswordWithKey'];
    ...
    $response = $ec2->get_password_data($instance_id, $opt);
