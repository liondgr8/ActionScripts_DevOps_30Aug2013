...
if (isset($options["group_name"]) && isset($options["group_description"])) {
    $group_name = $options["group_name"];
    $group_description = $options["group_description"];
    $opt = array();

    if (isset($options['VpcId'])) {
        $opt['VpcId'] = $options['VpcId'];
    ...
    $response = $ec2->create_security_group($group_name, $group_description, $opt);
