...
$longopts = array(
    "type:", // Required Value
    "customer_gateway_id:", // Required Value
    "vpn_gateway_id:", // Required Value
...
if (isset($options["type"]) && isset($options["customer_gateway_id"]) && isset($options["vpn_gateway_id"])) {
    $type = $options["type"];
    $customer_gateway_id = $options["customer_gateway_id"];
    $vpn_gateway_id = $options["vpn_gateway_id"];
    ...
    $response = $ec2->create_vpn_connection($type, $customer_gateway_id, $vpn_gateway_id, $opt);
