...
$longopts = array(
    "dhcp_configuration:", // Required Value
...
if (isset($options["dhcp_configuration"])) {
    $dhcp_configuration = $options["dhcp_configuration"];
    ...
    $response = $ec2->create_dhcp_options($dhcp_configuration, $opt);
