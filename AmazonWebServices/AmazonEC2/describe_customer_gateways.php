...
if (isset($options['CustomerGatewayId'])) {
    $opt['CustomerGatewayId'] = $options['CustomerGatewayId'];
...
$response = $ec2->describe_customer_gateways($opt);
