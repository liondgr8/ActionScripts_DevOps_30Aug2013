...
$longopts = array(
    "vpn_connection_id:", // Required Value
...
if (isset($options["vpn_connection_id"])) {
    $vpn_connection_id = $options["vpn_connection_id"];
    ...
    $response = $ec2->delete_vpn_connection($vpn_connection_id, $opt);
