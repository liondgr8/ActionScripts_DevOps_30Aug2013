...
$longopts = array(
    "spot_instance_request_id:", // Required Value
...
if (isset($options["spot_instance_request_id"])) {
    $spot_instance_request_id = $options["spot_instance_request_id"];
    ...
    $response = $ec2->cancel_spot_instance_requests($spot_instance_request_id, $opt);
