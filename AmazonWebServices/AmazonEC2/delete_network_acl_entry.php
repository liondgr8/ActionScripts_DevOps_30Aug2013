...
header("Content-network_acl_id: text/plain; charset=utf-8");
...
$longopts = array(
    "network_acl_id:", // Required Value
    "rule_number:", // Required Value
    "egress:", // Required Value
...
if (isset($options["network_acl_id"]) && isset($options["rule_number"]) && isset($options["egress"])) {
    ...
    $response = $ec2->delete_network_acl_entry($network_acl_id, $rule_number, $egress, $opt);
