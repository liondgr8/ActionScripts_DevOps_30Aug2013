...
if (isset($options['ReservedInstancesOfferingId'])) {
    $opt['ReservedInstancesOfferingId'] = $options['ReservedInstancesOfferingId'];
...
if (isset($options['InstanceTenancy'])) {
    $opt['InstanceTenancy'] = $options['InstanceTenancy'];

}
if (isset($options['OfferingType'])) {
    $opt['OfferingType'] = $options['OfferingType'];
...
$response = $ec2->describe_reserved_instances_offerings($opt);
