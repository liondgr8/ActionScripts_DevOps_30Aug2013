...
$longopts = array(
    "network_interface_id:", // Required Value
    "Description::", // Optional Value
    "SourceDestCheck::", // Optional Value
    "GroupSet::", // Optional Value
    "Attachment::", // Optional Value
...
if (isset($options["network_interface_id"])) {
    ...
    if (isset($options['SourceDestCheck'])) {
        $opt['SourceDestCheck'] = $options['SourceDestCheck'];

    }
    if (isset($options['GroupSet'])) {
        $opt['GroupSet'] = $options['GroupSet'];
    ...
    $response = $ec2->describe_network_interface_attribute($network_interface_id, $opt);
