...
$longopts = array(
    ...
    "rule_action:", // Required Value
    "egress:", // Required Value
    "cidr_block:", // Required Value
    "Icmp::", // Optional Value
    "PortRange::", // Optional Value
...
if (isset($options["network_acl_id"]) && isset($options["rule_number"]) && isset($options["protocol"]) && isset($options["rule_action"]) && isset($options["egress"]) && isset($options["cidr_block"])) {
    ...
    $response = $ec2->create_network_acl_entry($network_acl_id, $rule_number, $protocol, $rule_action, $egress, $cidr_block, $opt);
