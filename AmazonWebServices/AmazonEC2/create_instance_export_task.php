...
$longopts = array(
    ...
    "TargetEnvironment::", // Optional Value
    "ExportToS3::", // Optional Value
...
if (isset($options["instance_id"])) {
    ...
    if (isset($options['TargetEnvironment'])) {
        $opt['TargetEnvironment'] = $options['TargetEnvironment'];

    }
    if (isset($options['ExportToS3'])) {
        $opt['ExportToS3'] = $options['ExportToS3'];
    ...
    $response = $ec2->create_instance_export_task($instance_id, $opt);
