...
if (isset($options["association_id"]) && isset($options["network_acl_id"])) {
    ...
    $response = $ec2->replace_network_acl_association($association_id, $network_acl_id, $opt);
