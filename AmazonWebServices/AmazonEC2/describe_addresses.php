...
$longopts = array(
    "PublicIp::", // Required value
    "Filter::", // Optional value
    "AllocationId::", // Optional value
    "curlopts::", // No value
...
if (isset($options['PublicIp'])) {
    $opt['PublicIp'] = $options["PublicIp"];
...
if (isset($options['AllocationId'])) {
    $opt['AllocationId'] = $options['AllocationId'];
...
$response = $ec2->describe_addresses($opt);
