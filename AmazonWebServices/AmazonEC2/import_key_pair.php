...
$longopts = array(
    "key_name:", // Required Value
    "public_key_material:", // Required Value
...
if (isset($options["key_name"]) && isset($options["public_key_material"])) {
    $key_name = $options["key_name"];
    $public_key_material = $options["public_key_material"];
    ...
    $response = $ec2->import_key_pair($key_name, $public_key_material, $opt);
