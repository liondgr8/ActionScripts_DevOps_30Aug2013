...
$longopts = array(
    "GroupName::", // Required value
    "GroupId::", // Optional value
    "IpPermissions::", // Optional value
    "curlopts::", // No value
...
if (isset($options['IpPermissions'])) {
    $opt['IpPermissions'] = $options['IpPermissions'];
...
$response = $ec2->revoke_security_group_egress($opt);
