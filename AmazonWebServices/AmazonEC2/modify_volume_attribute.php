...
if (isset($options["volume_id"])) {
    $volume_id = $options["volume_id"];
    $opt = array();

    if (isset($options['AutoEnableIO.Value'])) {
        $opt['AutoEnableIO.Value'] = $options['AutoEnableIO.Value'];
    ...
    $response = $ec2->modify_volume_attribute($volume_id, $opt);
