...
$longopts = array(
    "conversion_task_id:", // Required Value
    "ReasonMessage::", // Optional Value
...
if (isset($options["conversion_task_id"])) {
    $conversion_task_id = $options["conversion_task_id"];

    $opt = array();

    if (isset($options['ReasonMessage'])) {
        $opt['ReasonMessage'] = $options['ReasonMessage'];
    ...
    $response = $ec2->cancel_conversion_task($conversion_task_id, $opt);
