...
$longopts = array(
    "type:", // Required Value
    "ip_address:", // Required Value
    "bgp_asn:", // Required Value
...
if (isset($options["type"]) && isset($options["ip_address"]) && isset($options["bgp_asn"])) {
    $type = $options["type"];
    ...
    $response = $ec2->create_customer_gateway($type, $ip_address, $bgp_asn, $opt);
