...
if (isset($options['KeySchema'])) {
    $opt['KeySchema'] = $options['KeySchema'];

}
if (isset($options['ProvisionedThroughput'])) {
    $opt['ProvisionedThroughput'] = $options['ProvisionedThroughput'];
